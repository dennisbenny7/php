        ...
        <div class="row">
            <div class="col-md-2">
                <div class="logo-left-15 pull-left">
                    <div class="h4" id="logo"><a href="index.php">KLC Blood Bank </a></div>
                </div>
            </div>
                ...
                <div class="pull-right">
                    <ul class="nav nav-pills">
                        ...
                        <li class="<?php if(isset($setJoinUsActive)){ echo $setJoinUsActive; } else { echo ''; } ?>">
                            <a href="register.php">GIVE BLOOD</a>
                        </li>
                        
                        <li class="<?php if(isset($setAvailabilityActive)) {echo $setAvailabilityActive;} else {echo '';} ?>">
                            <a href="availability.php">CHECK BLOOD</a>
                        </li>
                        
                        <li class="">
                            <a href="../index.php">KLC ADMIN Login</a>
                        </li>
